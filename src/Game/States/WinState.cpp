...
void WinState::render() {
	ofDrawBitmapString("Congratulations, you won!", ofGetWidth()/2, ofGetHeight()/2-300, 50);
	ofDrawBitmapString("Score: " + to_string(score), ofGetWidth()/2, ofGetHeight()/2-280, 50);
